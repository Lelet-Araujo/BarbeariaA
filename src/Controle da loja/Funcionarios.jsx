...
export default function FuncionarioPage() {
    ...
    const abrirAgendaFuncionario = (funcionario) => {
        navigate(`/agenda?funcionario=${encodeURIComponent(funcionario.nome)}`);
    };
                    ...
                    {funcionarios.map(func => (
                        <div key={func.id} className="funcionario-card">
                            ...
                            <div className="acoes-funcionario">
                                ...
                                <button type="button" onClick={() => abrirAgendaFuncionario(func)}>Agenda</button>
                            </div>
                        </div>
                    ))}
                </div>
